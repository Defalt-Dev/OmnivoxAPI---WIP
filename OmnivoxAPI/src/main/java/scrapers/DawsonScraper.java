...
public class DawsonScraper extends OmnivoxScraper {

    	/**
	 * The Omnivox login link for Maisonneuve college.
	 */
    private static final String loginUrl = "https://dawsoncollege.omnivox.ca/Login/Account/Login?ReturnUrl=%2fintr%2f";

    public DawsonScraper() {
        super(loginUrl);
    }
